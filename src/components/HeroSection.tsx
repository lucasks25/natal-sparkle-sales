        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="mb-8 flex justify-center">
            <div className="relative animate-float">
              <div className="w-40 h-40 rounded-full bg-gradient-to-br from-accent via-primary to-secondary flex items-center justify-center shadow-2xl animate-glow">
                <Sparkles className="w-20 h-20 text-primary-foreground animate-pulse" />
              </div>
              <div className="absolute -top-2 -right-2 w-12 h-12 rounded-full bg-secondary flex items-center justify-center animate-bounce">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up">
            <Button
              ...
              className="text-lg px-8 py-6 bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary shadow-lg hover:shadow-xl animate-glow group"
            >
          ...
          <div className="mt-12 flex items-center justify-center gap-8 flex-wrap text-sm text-muted-foreground animate-fade-in">
